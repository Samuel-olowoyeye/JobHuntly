...
const page = () => {
  return (
    <div className="lg:flex flex-row bg-[#FFFFFF] w-full lg:h-[850px] xl:h-screen">
      ...
      <div className='xl:mx-auto xl:my-auto mt-[56px] lg:mt-[123px] lg:ml-[204px] px-4'>
        ...
        <h1 className='py-6 font-Red_Hat_Display font-semibold text-[#202430] text-[32px] xl:text-[48px] text-center'>Welcome Back, Dude </h1>
        ...
        <button className='flex flex-row justify-center items-center gap-2 border border-[#CCCCF5] w-full'>
          ...
          <h3 className='py-3 xl:py-4 font-Epilogue font-bold text-[#4640DE] text-[16px] xl:text-[20px]'>Login with Google</h3>
        </button>

        <div className='flex flex-row justify-center py-6'> 
          <h3 className="flex items-center w-full font-Epilogue text-[#A8ADB7] text-[16px]">
              <span className="inline-flex bg-[#A8ADB7] w-1/3 h-[1px]"></span>
              <span className="w-2/3 text-center">Or login with email </span>
              <span className="inline-flex bg-[#A8ADB7] w-1/3 h-[1px]"></span>
            </h3>
        </div>
        ...
        <form>
          ...
          <div className='flex flex-row items-center gap-4 pb-[22px] font-Epilogue'>
            <input type="checkbox"  className='border border-[#D6DDEB] rounded-lg w-6 h-6' />
            <h3 className='text-[#515B6F] text-[16px] xl:text-[20px]'>Remember me</h3>
          </div>


          <button type='submit' className='w-full'>
            <h3 className='bg-[#4640DE] py-3 xl:py-4 font-Epilogue font-bold text-[#ffffff] text-[16px] xl:text-[20px]'>Login</h3>
          </button>
        </form>

        <h3 className='py-6 font-Epilogue text-[#202430] text-[16px] xl:text-[20px]'>Don’t have an account? <Link href="/Signup"> <span className='font-semibold text-[#4640DE]'>Sign Up</span> </Link></h3>
