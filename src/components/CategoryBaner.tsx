...
const CategoryBaner = () => {
  return (
    <div className="flex lg:flex-row flex-col gap-[26px] lg:gap-[190px] xl:gap-[280px] bg-[url('/RectangleMobile.svg')] lg:bg-[url('/Rectangle.svg')] bg-cover bg-no-repeat mb-[40px] lg:mb-[72px] w-full lg:w-[1192px] xl:w-full h-[670px] lg:h-[414px]" >
      <div className='pt-[88px] lg:pt-[93px] lg:pb-[91px] pl-4 lg:pl-[70px] xl:pl-[140px] w-[364px] xl:w-[464px] text-center lg:text-start'>
          ...
          <button>
            <h3 className='bg-[#FFFFFF] mb-[26px] lg:mb-0 px-[105px] lg:px-6 py-3 font-Epilogue font-bold text-[#4640DE] text-[16px]'>Sign Up For Free</h3>
          </button>
      </div>
      <div className='pl-4'>
